...
import { VStack, Box, Image, AspectRatio, Stack, Heading, HStack, Center, Divider, Flex } from "native-base";
		...
		<Box alignItems="center">
			...
			>
				...
				<Stack p="4" space={3}>
					...
					<Text fontWeight="400">{DisplayPanelDiseaseData({ JSONdata })}</Text>
